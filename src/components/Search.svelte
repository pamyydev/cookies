<script lang="ts">
  ...
  const fakeResult = [
  {
    url: url('/'),
    meta: {
      title: 'Entenda os Cookies: São Heróis ou Vilões?',
    },
    excerpt:
      'Cookies podem ser seus aliados na web, mas é importante entender como eles funcionam.',
  },
  {
    url: url('/'),
    meta: {
      title: 'Por Que a Privacidade Online é Essencial?',
    },
    excerpt:
      'Descubra os riscos de dados não protegidos e como proteger sua navegação online.',
  },
  {
    url: url('/'),
    meta: {
    ...
    excerpt:
      'A Lei Geral de Proteção de Dados é uma grande mudança no cenário digital brasileiro. Saiba mais.',
  },
  {
    url: url('/'),
    meta: {
      title: 'Segurança Online: Como se Proteger de Cookies Maliciosos',
    },
    excerpt:
      'Aprenda as melhores práticas para evitar ser rastreado por cookies indesejados.',
  },
]
